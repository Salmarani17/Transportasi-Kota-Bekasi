...
<head>
    ...
    <title>Transportasi Kota Bekasi</title>
...
© 2026 Transportasi Kota Bekasi. All Rights Reserved. | Dev: Salma Rani Ardelia & Najla Kenny Putri Utami
</div>
</footer>
...
// ================= FETCH DATA =================
fetch('http://127.0.0.1:8001/api/sliders')
.then(res => res.json())
.then(data => {
    ...
    data.forEach((slider, index) => {
        ...
        div.innerHTML = `
            <img src="http://127.0.0.1:8001/storage/${slider.image}">
        `;
    ...
    // update slides & dots setelah render
